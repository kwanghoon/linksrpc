...
%
Thus, the augmented relaxed polymorphic RPC calculus makes explicit
the declared location of applications and checking its validity in
runtime.
%
...
%
Now let us defined the augmented relaxed polymorphic RPC calculus. 
%
Figure \ref{fig:polyrpcm} presents terms and a dynamic semantics for
an {\it augmented relaxed polymorphic RPC calculus}, \polyrpcA.
%
