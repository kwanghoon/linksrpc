...
% Author info
\title{On How To Add Static Location Contexts To Links\\(A progress report)}
...
%  
  ...
  \\
  \ \ \ \ \ \ \ \ \ (local/remote procedure calls after dynamic location checking)
  \\[\ruleverticalsephalf]
%  
  $\judgcomp{\Lambda l.V}{\tyenv,\Loc,\forall l.B} \ = \
  \Lambda\alpha.\lamL{\anncomp{\Loc}}{\loctmcomp{l}}{ \judgcomp{V}{\tyenv,\Loc,B} }$
  \\[\ruleverticalsephalf]
%  
