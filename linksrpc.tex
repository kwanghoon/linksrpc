...
%  
  ...
  & let $\typing{\Delta,x:\tycomp{A}{a}}{a}{M'}{D}$
    \ = \ $\judgcomp{ \typing{\tyenvExt{x}{A}}{}{M}{B} }{(\Delta,x:\tycomp{A}{a}),a}$
  \\[\ruleverticalsephalf]
  &
  & $\typing{\Delta}{\Loc}{\lamL{a}{x}{M'}}{\tycomp{A}{a} \funL{a} D}$
  \\[\ruleverticalsep]
%  
  ...
  \\
  &
  & let $\typing{\Delta,l,x:\tycomp{A}{l}}{l}{M'}{D}$
    \ = \ $\judgcomp{ \typing{\tyenvExt{x}{A}}{}{M}{B} }{(\Delta,l,x:\tycomp{A}{l}),l}$
  \\[\ruleverticalsephalf]
  &
  & {
      \begin{prooftree}
        \hypo{
          \begin{prooftree}
            \hypo{ \typing{\Delta,l}{\Loc}{\lamL{l}{x}{M'} }{ \tycomp{A}{l}\funL{l}D } }
            \infer1{ \typing{\Delta}{\Loc}{\Lambda l.\lamL{l}{x}{M'} }{ \forall l.(\tycomp{A}{l}\funL{l}D) } }
          \end{prooftree}
        }
        \infer1{ \typing{\Delta}{\Loc}{(\Lambda l.\lamL{l}{x}{M'})[\Loc] }{ (\tycomp{A}{l}\funL{l}D)\subst{\Loc}{l}} }
      \end{prooftree}
    }
...
%  
  ...
  \\[\ruleverticalsephalf]
  &
  & $\typing{\Delta}{\Loc}{M'[ \ \tycomp{B}{\Loc} \ ]}{C\subst{ \tycomp{B}{\Loc} }{\alpha}}$
  \\[\ruleverticalsep]
\end{tabular}
...
is, $\tycomp{A}{a}$ or $\tycomp{A}{l}$ for some fresh location
variable.

\subsection{Problem: Violating the Syntactic Restriction of Polymorphism}
...
compiled type abstraction not to be in the form of values any more.
