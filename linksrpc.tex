...
%
So, a view of the application of a client function to an integer 123
as a remote procedure call is broken.

%
With value restriction on polymorphism, we will never face this
problem because both $f \ [Int]$ and $f \ [String]$ are enforced to by
