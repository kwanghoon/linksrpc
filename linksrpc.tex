...
family for the purpose of integrating {\it effectful} features, such
as mutable references, with polymorphism without breaking type safety.
%
...
on polymorphism.
%
We discuss why this relaxation can break the type safety unless it is
carefully dealt with and how the relaxed calculus is designed to
